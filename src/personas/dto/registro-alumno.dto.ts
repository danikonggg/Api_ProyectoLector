...
export class RegistroAlumnoDto {
  ...
  @ApiProperty({
    example: 1,
    description: 'ID de la escuela. Obligatorio para admin. Opcional para director.',
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    example: 'A',
    description: 'Grupo o sección. Si se envía con grado, se valida que exista en la escuela.',
    required: false,
    maxLength: 20,
  })
  @IsString()
  ...
  @ApiProperty({
    example: 2,
    description: 'ID del grupo (alternativa a grado+grupo). El grupo debe existir en la escuela.',
    required: false,
  })
  @IsOptional()
  @IsInt()
